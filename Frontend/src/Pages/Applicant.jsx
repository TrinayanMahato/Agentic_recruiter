                        ...
                        <form className="flex flex-col gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input className="w-full rounded-lg border border-slate-300 dark:border-slate-600 bg-transparent pl-11 pr-4 py-3 text-sm text-slate-900 dark:text-white placeholder-slate-400 focus:border-[#1152d4] focus:ring-1 focus:ring-[#1152d4] outline-none transition-all" id="email" placeholder="jane.doe@example.com" type="email" required />
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 mt-2">
                                ...
                                <div className="relative flex flex-col items-center justify-center w-full min-h-[180px] rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 hover:border-[#1152d4] transition-all cursor-pointer group">
                                    <input className="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" type="file" required />
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                        ...
                                        <p className="mb-1 text-sm text-slate-900 dark:text-white font-medium">Click to upload or drag and drop</p>
                            ...
                            <div className="pt-4">
                                <button className="w-full rounded-lg bg-[#1152d4] py-4 px-8 text-base font-bold text-white shadow-lg shadow-blue-500/20 hover:bg-blue-700 hover:shadow-blue-500/30 transition-all active:scale-[0.98]" type="button">
                                    Submit Application
                                </button>
